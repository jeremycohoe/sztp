...
PODS = {
    ...
    "FOC2727Y739": ("c9300x-pod01a", 21, 5),
    "FOC2727Y6MX": ("c9300x-pod02a", 22, 5),
    "FOC2727Y75Q": ("c9300x-pod03a", 23, 5),
    "FOC2727Y767": ("c9300x-pod04a", 24, 5),
    "FOC2727Y72E": ("c9300x-pod05a", 25, 5),
    "FOC2727Y72J": ("c9300x-pod06a", 26, 5),
    "FOC2727Y6TE": ("c9300x-pod07a", 27, 5),
    "FOC2727Y70N": ("c9300x-pod08a", 28, 5),
    "FOC2727Y72F": ("c9300x-pod09a", 29, 5),
    "FOC2727Y72G": ("c9300x-pod10a", 30, 5),
    "FOC2727Y6ML": ("c9300x-pod11a", 31, 5),
    "FOC2727Y6TW": ("c9300x-pod12a", 32, 5),
    "FOC2727Y73C": ("c9300x-pod13a", 33, 5),
    "FOC2727Y6Z9": ("c9300x-pod14a", 34, 5),
    "FOC2727Y6EJ": ("c9300x-pod15a", 35, 5),
    "FOC2727Y71E": ("c9300x-pod16a", 36, 5),
    "FOC2727Y6MU": ("c9300x-pod17a", 37, 5),
    "FOC2727Y6X1": ("c9300x-pod18a", 38, 5),
    "FOC2724YB76": ("c9300x-pod19a", 39, 5),
    "FOC2727Y73Z": ("c9300x-pod20a", 40, 5),
    "FOC2724YBQ4": ("c9300x-pod21a", 41, 5),
    "FOC2724YBQ9": ("c9300x-pod22a", 42, 5),
    "FOC2724YBQH": ("c9300x-pod23a", 43, 5),
    "FOC2724YBSA": ("c9300x-pod24a", 44, 5),
    "FOC2724YBPN": ("c9300x-pod25a", 45, 5),
    "FOC2724YBPZ": ("c9300x-pod26a", 46, 5),
    "FOC2724YBP8": ("c9300x-pod27a", 47, 5),
    "FOC2724YBS5": ("c9300x-pod28a", 48, 5),
    "FOC2724YBMS": ("c9300x-pod29a", 49, 5),
    "FOC2724YBPM": ("c9300x-pod30a", 50, 5),

    # ---- C9300 (ACT2) — even "b" half of each pod, last octet .55 ----
    "FCW2129G042": ("c9300-pod01b", 21, 55),
    "FCW2129G01K": ("c9300-pod02b", 22, 55),
    "FCW2129G02M": ("c9300-pod03b", 23, 55),
    "FCW2129L05L": ("c9300-pod04b", 24, 55),
    "FCW2129L03E": ("c9300-pod05b", 25, 55),
    "FCW2241DH93": ("c9300-pod06b", 26, 55),
    "FCW2126G05V": ("c9300-pod07b", 27, 55),
    "FCW2241AHB1": ("c9300-pod08b", 28, 55),
    "FCW2129L0DU": ("c9300-pod09b", 29, 55),
    "FCW2241AHAT": ("c9300-pod10b", 30, 55),
    "FCW2129G02U": ("c9300-pod11b", 31, 55),
    "FCW2129L05A": ("c9300-pod12b", 32, 55),
    "FCW2241CHAT": ("c9300-pod13b", 33, 55),
    "FCW2129L049": ("c9300-pod14b", 34, 55),
    "FCW2241CH9K": ("c9300-pod15b", 35, 55),
    "FCW2241D0KM": ("c9300-pod16b", 36, 55),
    "FCW2129G0EF": ("c9300-pod17b", 37, 55),
    "FCW2129L09E": ("c9300-pod18b", 38, 55),
    "FCW2241BH95": ("c9300-pod19b", 39, 55),
    "FCW2241BH96": ("c9300-pod20b", 40, 55),
    "FCW2129L04A": ("c9300-pod21b", 41, 55),
    "FCW2241DHBH": ("c9300-pod22b", 42, 55),
    "FCW2146G095": ("c9300-pod23b", 43, 55),
    "FCW2241DHBN": ("c9300-pod24b", 44, 55),
    "FCW2129L02R": ("c9300-pod25b", 45, 55),
    "FCW2129L03Z": ("c9300-pod26b", 46, 55),
    "FCW2129G03A": ("c9300-pod27b", 47, 55),
    "FCW2129G03G": ("c9300-pod28b", 48, 55),
    "FCW2129G0PZ": ("c9300-pod29b", 49, 55),
    "FCW2129L05N": ("c9300-pod30b", 50, 55),

    # ---- C9350 "c" devices (FVH*) --------------------------------------
    # Mgmt last-octet = .15 (a=.5 / c=.15 / b=.55)
    "FVH2943LHRX": ("c9350-pod01c", 21, 15),
    "FVH2943LJQX": ("c9350-pod02c", 22, 15),
    "FVH2944LC8A": ("c9350-pod03c", 23, 15),
    "FVH2943LHUA": ("c9350-pod04c", 24, 15),
    "FVH2943LJKM": ("c9350-pod05c", 25, 15),
    "FVH2943LJWE": ("c9350-pod06c", 26, 15),
    "FVH2944LDKS": ("c9350-pod07c", 27, 15),
    "FVH2944LCXF": ("c9350-pod08c", 28, 15),
    "FVH2943LHSM": ("c9350-pod09c", 29, 15),
    "FVH2943LJ3Z": ("c9350-pod10c", 30, 15),
    "FVH2943LJ0E": ("c9350-pod11c", 31, 15),
    "FVH2943LJNK": ("c9350-pod12c", 32, 15),
    "FVH2944L1ZY": ("c9350-pod13c", 33, 15),
    "FVH2943LHSV": ("c9350-pod14c", 34, 15),
    "FVH2943LJFE": ("c9350-pod15c", 35, 15),
    "FVH2944LEXF": ("c9350-pod16c", 36, 15),
    "FVH2943LK9C": ("c9350-pod17c", 37, 15),
    "FVH2943LJN5": ("c9350-pod18c", 38, 15),
    "FVH2943LHME": ("c9350-pod19c", 39, 15),
    "FVH2944LEXA": ("c9350-pod20c", 40, 15),
    "FVH2943LHMV": ("c9350-pod21c", 41, 15),
    "FVH2944L20P": ("c9350-pod22c", 42, 15),
    "FVH2944LDFS": ("c9350-pod23c", 43, 15),
    "FVH2944LDFR": ("c9350-pod24c", 44, 15),
    "FVH2944LDBP": ("c9350-pod25c", 45, 15),
    "FVH2943LHZZ": ("c9350-pod26c", 46, 15),
    "FVH2944L20B": ("c9350-pod27c", 47, 15),
    "FVH2943LJHN": ("c9350-pod28c", 48, 15),  # was UNKNOWN — only remaining staged FVH
    "FVH2943LJUZ": ("c9350-pod29c", 49, 15),
    "FVH2944L204": ("c9350-pod30c", 50, 15),
}
...
# classic-ZTP-onboarded ones at a glance (e.g. c9300-pod22b-sztp).
...
def apply_uplink_role(hostname):
    ...
    elif hostname.startswith("c9300-"):
